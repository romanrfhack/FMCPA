...
public sealed class FederationDonationApplicationCommissionConfiguration : IEntityTypeConfiguration<FederationDonationApplicationCommission>
{
    public void Configure(EntityTypeBuilder<FederationDonationApplicationCommission> builder)
    {
        builder.ToTable("FederationDonationApplicationCommissions");
        ...
        builder.HasOne(commission => commission.FederationDonationApplication)
            .WithMany(application => application.Commissions)
            .HasForeignKey(commission => commission.FederationDonationApplicationId)
        ...
        builder.HasIndex(commission => commission.FederationDonationApplicationId);
