...
| Donatarias | Validación documental de suficiencia | `[Disponible con alcance acotado]` | El sistema valida presencia mínima de evidencia, no suficiencia legal ni calidad del contenido. Evidencia: `document-management-track.md`, `risks.md` R-072/R-074. |
